...
<div class="py-4 px-4 mx-auto max-w-screen-xl lg:px-6">
  <div class="mx-auto max-w-screen-md sm:text-center">
    <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl dark:text-white">Cari Artikel</h2>
    <p class="mx-auto mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">
      Temukan artikel yang cocok denganmu!!, permudah dengan website kami
    </p>

    <!-- FORM START -->
    <form method="GET" action="/posts"> <!-- atau sesuaikan action-nya -->
        @if (request('category')) 
      ...
      <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
        <div class="relative w-full">
          ...
          <input
            ...
            placeholder="Search Artikel" type="text" id="search" name="search" autocomplete="off"/>
        </div>
        <div>
          <button type="submit"
    ...
    {{-- <article class="py-8 mx-w-screen-md border-b border-gray-300">
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-5 text-gray-500">
                 ...
                 <a href=""><h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900  dark:text-white">{{ $post->title }}</h2></a>
   ...
   <div>
    ...
    <p href="/posts" class="bloc text-blue-600 hover:underline">&laquo;Back to all posts</p>
   </div>
    @endforelse
         </div>  
    </div>
